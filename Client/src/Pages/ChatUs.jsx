...
export default function ChatUs() {
  ...
  const { teamMembers, role } = useUser();
                    ...
                    >
                      {!isMine && (
                        msg.sender?.image ? (
                          ...
                          <div
                            className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold text-white mr-2 mt-1"
                            style={{
                              backgroundColor: msg.sender?.name
                                ? `hsl(${msg.sender.name.charCodeAt(0) * 15 % 360}, 70%, 50%)`
                                : "#999"
                            }}
                          >
