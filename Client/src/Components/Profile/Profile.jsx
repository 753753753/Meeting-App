...
function Profile() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center relative overflow-hidden px-6 md:px-12 pb-12">
            ...
            {role === 'user' && (
                <div className="max-w-5xl w-full mt-10">
                    <h2 className="text-xl font-semibold mb-4">My Team Leader</h2>
                    {teamLeader ? (
                        <div className="flex items-center bg-gray-800 p-4 rounded-2xl shadow-lg border border-gray-700 hover:scale-105 transform transition-transform duration-300">
                            <img
                        ...
                        <p className="text-gray-400">No team leader assigned yet.</p>
                    )}
                </div>
            )}
