...
const Header = ({ toggleSidebar }) => {
  ...
  <div className="absolute left-1/2 transform -translate-x-1/2 sm:hidden flex items-center space-x-2">
    <img src={logo} alt="LinkUp Logo" className="w-10 h-10" />
    <h1 className="text-xl font-bold text-white">LINK UP</h1>
  </div>
